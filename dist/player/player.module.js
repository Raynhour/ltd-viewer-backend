...
const http_modulle_1 = require("../api/http.modulle");
...
const externalGames_service_1 = require("../game/externalGames.service");
...
exports.PlayerModule = PlayerModule = __decorate([
    (0, common_1.Module)({
        imports: [
            cache_manager_1.CacheModule.register({ ttl: 600000 }),
            ...
            http_modulle_1.HttpWrapperModule
        ],
        controllers: [player_controller_1.PlayerController],
        providers: [
            player_service_1.PlayerService,
            externalPlayer_service_1.ExternalPlayerService,
